      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm" style={{ color: theme.colors.text.secondary }}>
            Or{' '}
            <Link href="/" className="font-medium hover:opacity-80" style={{ color: theme.colors.primary[600] }}>
              return to home
            </Link>
          </p>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link href="/signup" className="font-medium hover:opacity-80" style={{ color: theme.colors.primary[600] }}>
